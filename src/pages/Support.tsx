...
const Support = () => {
  ...
  React.useEffect(() => {
    console.log("[Support.tsx] Loaded SupportCenter tickets:", tickets);
  }, [tickets]);
  ...
  return (
    <div className="py-8 space-y-6" style={{ backgroundColor: 'var(--theme-background, rgb(250, 250, 250))' }}>
      ...
      <div className="enhanced-card rounded-xl shadow-sm border p-6">
        <h2 className="text-xl font-semibold mb-4 gradient-text">Frequently Asked Questions</h2>
        <div className="space-y-4">
          ...
          <div className="border-b pb-4">
            <h3 className="font-medium mb-2">Can I customize my booking form?</h3>
            <p className="text-muted-foreground text-sm">
              Yes, you can customize your booking forms with custom fields, branding, and specific questions for your clients.
            </p>
          </div>
          <div className="pb-4">
            <h3 className="font-medium mb-2">Is there a mobile app available?</h3>
            <p className="text-muted-foreground text-sm">
              Currently, Jusbook is available as a responsive web application. A dedicated mobile app is in development.
            </p>
          </div>
        </div>
      </div>
